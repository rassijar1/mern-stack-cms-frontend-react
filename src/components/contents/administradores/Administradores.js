...
columns: [
            ...
            render: function(data){
            	...
            	return ` <a href="" class="editarInputs" data-toggle="modal" data-target="#editarAdmin" data="${data}"><svg style="color:black; background:orange; border-radius:100%; width:35px; line-height:35px; text-align:center; padding:10px"
            			 ...
            			 <a href="" class="borrarInput" data=${data}><svg style="color:white; background:#dc3545; border-radius:100%; width:35px; line-height:35px; text-align:center; padding:10px"
...
<div className="content-wrapper" style={{minHeight: "494px" }}>
			...
			{/*=============================================
			Ventana modal editar y borrar admins
			=============================================*/}
...
/*======================================================
PETICIONES GET ADMINISTRADORES
======================================================*/
